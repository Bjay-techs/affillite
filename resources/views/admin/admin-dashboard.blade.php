 ...
 <div>
         ...
         @if(session('message'))
         <p class="alert alert-success" style="margin-left: 300px;">
     ...
     <div class="container cc">
         <div class="row row-cols">
             ...
             <div class="col bg-danger"><a class="nav-icon fas fa-bookmark" href="#"> <br>FC $100 <br>{{$fc1}}</a> </div>
             <div class="col bg-warning"><a class="nav-icon fas fa-money" href="#"> <br>FC $200<br />{{$fc2}}</a></div>
             <div class="col bg-info"><a class="nav-icon fas fa-gift" href='#'> <br>Standard <br>{{$sta}}</a></div>
